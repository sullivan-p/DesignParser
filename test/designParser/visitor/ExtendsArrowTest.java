...
public class ExtendsArrowTest {

	private final static String[] OBJECT_NAMES = { "appLauncherSltn.DataFileRunner",
	...
	public void test() throws IOException {
		...
		IUmlGenerator umlGenerator = new UmlGenerator("TestExtendsArrow", designModel, OBJECT_NAMES);
